...
export const FHPath: { [key: string]: { label: string; link: string } } = {
  ...
  noWords: { label: '토픽 요청', link: '/services/noWords' },
  ...
  columns: { label: 'GPT 칼럼', link: '/services/columns' },
  columnCreate: { label: 'GPT 칼럼 생성', link: '/services/columns/create' },
  columnDetail: { label: 'GPT 칼럼 상세', link: '/services/columns/:id' },
  columnCommentReport: {
    label: 'GPT 칼럼 신고 댓글',
